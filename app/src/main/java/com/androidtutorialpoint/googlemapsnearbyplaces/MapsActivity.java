...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btn_Hoteles.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData(lat_long);
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Hoteles cercanos", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(MapsActivity.this,"Tu ubicación actual", Toast.LENGTH_LONG).show();
